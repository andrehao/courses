...
export class RecipeService {
	...
	storeData() {
		...
		return this.http.put('https://recipebook-ff0c2.firebaseio.com/recipes.json', body, {headers: headers});

	}

	fetchData() {
		return this.http.get('https://recipebook-ff0c2.firebaseio.com/recipes.json')
